...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-12-05T07:25:20.947Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x6A706468B6E27d44C996340B373d28921AD0024d",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x6A706468B6E27d44C996340B373d28921AD0024d",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0x4049BA3DD9e820Be2D3d35B77162C3A6D6E2553d",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0xa7f7888f798D51Cb54bd7F9B45eA96239c5720e2",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0xFE9a36c5f50A4Dd486e8D3fD60D11bBc1D2A7cF8",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0xa276EB020d90539D4cBA429635f56828c757ee8a",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0xb6AF510Bf3C1d81b99318917d2dDC9FFCc180209",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0x6Fb6effE6e2f306A37Ed0aEFBd7Ba31409c0209a",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0x23982Ff418065174f1314a24FaA4ABE28676BAba",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0x728A3AbA0A93fd39D09b50a022C0bDC5352681c1",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0x84a44C9F3F84a3d9F6914dd785F8C862ffE11ad2",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0x672BE24e7C54429Ce7Cf8942bba8B674B57A0e56",
