...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-12-01T08:31:44.189Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x4FC400e91c907637109d380B28644ac8E0761a0F",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x4FC400e91c907637109d380B28644ac8E0761a0F",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0x306b4cdEfcb64f8525c11d6773931B1E13eC11EF",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0x55955AA969f36440Ec996ccee70a63dfAdd3293F",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0xA6ACaB77ab74FeBEC9E0b555E59BF4EF5f231Ea7",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0xd2269A394dea390284E3766A7f9E02D17169dAd1",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0x06092EF96E4e2Ee8D9709851bc44755eff66E0d2",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0x699CD4E5bF541d6956306F3F670f995285CD8D73",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0xa2037ed5CD30E678AC8838d1fbCEa06B42f35941",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0x1CDa25bd6E7a5Fa02c67b9043F348eDeD889d142",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0xcdBF3F0e8E63423cBAef9cc844b445906e64B8C0",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0x31c20c7cB05fc4B052Ebac266ec969bcB9f6c8E8",
