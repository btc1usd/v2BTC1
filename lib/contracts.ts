...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-11-07T15:53:59.400Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0xD820EB1CF616eBD78Ae6e63EB3b48dea26c27515",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0xD820EB1CF616eBD78Ae6e63EB3b48dea26c27515",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0xE88FCdac43e28acAAd382e7287C1BD30a20B390d",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0xb447F03297b348290Cc6Ca28BFDA34A0Ca603e5F",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0x96Cb4b300b68bE6F0f2Aa11E88b1aD7Aa24015F1",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0x8F95B558cB9281D826d127fa28e56Ffc55Ed47ba",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0xA1A093f015C490579D52A73efBd0000983BEF0dA",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0x1191c1F036A8277994BEdf77C5aD1A26Efa63fdf",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0xf9Bc2dc97aAe8eC29809780cAB18FABFd0aa614A",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0x2dff025660aBbc8f8CFB775C8842232275Aa8534",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0x2E833582C7e607956FeEA8F4E64f3c12f784ce3F",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0xDf727fe08E68fD8D38d886FFE5e0912d091E96b7",
...
export const PROTOCOL_CONSTANTS = {
  ...
  // ============================================
  // TESTNET (current): 7 hours (25200 seconds)
  // MAINNET: Change to 7 * 24 * 60 * 60 (604800 seconds) for weekly distributions
  DISTRIBUTION_INTERVAL: 7 * 60 * 60,
