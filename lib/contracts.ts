...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-mainnet.json (2026-01-05T18:27:11.502Z)
  BTC1USD:
  ...
  ENDOWMENT_MANAGER:
    ...
    "0x4DC93Db87DD197eA214E00a60Db6a68c6652523b",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0x5F8dd5af0C289DeC09871FeAEd4050A4b5B4815A",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0x53531Fb9204575F998D5bF46470a8Aee2B1A2e17",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0xf7D9655656F8ad38d915dDbdE0bceC7530598b56",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0xD720b15020d78Ba9484EC13270B1D24b03135927",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0xF54e982F181F50bB28Af831258D47Bdb89d89c7b",
