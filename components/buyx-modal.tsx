  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()} modal={false}>
      ...
      >
        ...
        <ScrollArea className="flex-1 overflow-y-auto overflow-x-auto px-4 pb-6 [&>div]:whitespace-nowrap">
